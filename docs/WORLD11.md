...
| Колония трубчатых губок | `cpp/render/gl33/World11TubeSpongeGeometry.*` | 15 полых бугристых труб в четырёх пучках вокруг `kWorld11Colony`: изогнутая ось, скруглённая кромка, тёмная полость с дном. Текстура `0x0000001D.fget` (`scripts/generate_sponge.py`), тайл 1 м. Коллизий нет, как и у прежней колонии |
...
- `Gl33WorldRenderer.cpp`: `drawWorld11Landmarks`, отдельный шероховатый меш
  камня с внешними нормалями. Колония — трубчатые губки (см. таблицу выше), тёплые метки ведут назад.
